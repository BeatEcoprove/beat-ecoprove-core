...
{
    Task<ClothResult> AddClothToCloset(
        Profile profile,
        Cloth cloth,
        string brandName,
        string colorHex,
    ...
    Task<ErrorOr<Bucket>> AddBucketToCloset(
        Profile profile,
        Bucket bucket,
    ...
    Task<ErrorOr<Bucket>> AddClothToBucket(
        Profile profile,
        Bucket bucket,
        List<ClothId> cloths,
        CancellationToken cancellationToken = default
    ...
    Task<ErrorOr<Bucket>> RemoveClothFromBucket(
        Profile profile,
        Bucket bucket,
        List<ClothId> clothToRemove,
        CancellationToken cancellationToken
    );

    Task<ErrorOr<Cloth>> GetCloth(
        Profile profile,
        ClothId clothId,
        CancellationToken cancellationToken = default
    );

    Task<ErrorOr<ClothResult>> GetClothResult(
        Profile profile,
        ClothId clothId,
    ...
    Task<ErrorOr<ClothResult>> RemoveClothFromCloset(
        Profile profile,
        ClothId clothId,
        CancellationToken cancellationToken
    );

    Task<ErrorOr<BucketResult>> RemoveBucketFromCloset(
        Profile profile,
        BucketId bucketId,
        CancellationToken cancellationToken
    );
